...
// Display validation error, if any
                                ...
                                <h3 style="padding-left:50px; text-align:center;color:blue; font-family:sans-serif;"><img class="logo"src="assets/img/logo1.png" alt="logo"/>Church Worker Registration</h3>
                                ...
                                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" style="padding-left:80px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="user_type" required>
                                            ...
                                            <option value="Worker">Church worker / Department Head</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                   ...
                                   <div class="form-group">
                                        <label for="Branch Region">Branch Region <span class="login-danger">*</span></label>
                                        <input type="text" class="form-control" name="branch_region" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="date_assigned">Date <span class="login-danger">*</span>(date you came into contact with / Assigned to Church)</label>
