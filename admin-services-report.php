...
$allowed_user_types = array('Branch_Pastor', 'Admin', 'Assistant_Pastor');
...
<body>
    <div class="container">
        <h3 class="text-center mb-4"> Service Reports by uploads</h3>
        <div class="container">
        <?php
...
<div class="upload-form">
        <h5><a href="service.php"class="btn btn-info text-center">Enter Service Report</a></h5><br>
        <h5 class="text-center">Upload Report (PDF, DOCX, JPG etc. )</h5>
...
<div class="view-form">
        ...
        <!-- Search form -->
        <form method="get" action="admin-services-report.php">
            <div class="form-group">
                <input type="text" class="form-control" name="search_branch" placeholder="Search by Branch Name">
            </div>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo $report['file_path']; ?>" class="btn btn-primary btn-sm" download>Download</a>
