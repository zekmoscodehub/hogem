...
<div class="main">
    <div class="cardr">
        <?php
        if (!empty($successMsg)) {
            echo '<p class="text-success" style="text-align: center; font-size: 16px;">' . $successMsg . '</p>';
        }
        if (!empty($errorMsg)) {
            echo '<p class="text-danger" style="text-align: center; font-size: 16px;">' . $errorMsg . '</p>';
        }
        ?>

        <a href="branch-view-financials.php" class="btn btn-primary">View Financial Report</a>
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <input class="form-control" type="number" id="tithes_amount" name="tithes_amount" min="0" required>

            <label for="offering_amount">Offering Amount:</label>
            <input class="form-control" type="number" id="offering_amount" name="offering_amount" min="0" required>

            <label for="pledges_amount">Pledges Amount:</label>
            <input class="form-control" type="number" id="pledges_amount" name="pledges_amount" min="0" required>

            <input class="btn btn-success" type="submit" value="Submit">
            <a class="btn btn-primary" href="branch_main.php">Home</a>
